...
class Views::Users::Registrations::New < Views::Base
  ...
  def view_template
    div(class: "min-h-screen bg-background py-12 px-4") do
      div(class: "mx-auto max-w-lg") do
        div(class: "mb-8 text-center") do
          ...
          Heading(level: 1, class: "text-2xl") { "Create your account" }
          Text(class: "text-muted-foreground mt-1") { "Set up your wedding in minutes" }
        end
